...
export default function DashProfile() {
  ...
  // to change the image when selected from the browser
  useEffect(()=>{
    if(imageFile){
      uploadImage();
    }
  ...
  const uploadImage = async()=>{
    ...
    // adding time to the name ofthe image as name can be same of two images or files
    const fileName = new Date().getTime() + imageFile.name;
    const storageRef = ref(storage,fileName);
    // uploadTask is a method used to upload the image and get the information regarding the amount of bytes thats being uploaded
