import { Navbar,TextInput,Button, NavbarCollapse, Dropdown, Avatar, DropdownDivider } from 'flowbite-react';
    ...
    <Navbar className='border-b-2'>
        ...
        <div className='flex gap-2 md:order-2 mr-10'>
          ...
          (
            ...
            >
              <Dropdown.Header>
                <span className='block text-sm'>@{currentUser.username}</span><br/>
